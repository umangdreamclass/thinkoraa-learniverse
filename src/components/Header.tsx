          ...
          <div className="flex justify-between items-center text-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button 
                asChild
                size="sm"
                className="bg-white text-primary hover:bg-white/90 h-7 px-3 py-0"
              >
                <a href="https://wa.me/911234567890" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5">
