...
import { Menu, X, Phone, Mail, Facebook, Instagram, Linkedin, Twitter, Youtube } from "lucide-react";
        ...
        <div className="container">
          <div className="flex justify-between items-center text-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://wa.me/911234567890" target="_blank" rel="noopener noreferrer" className="hover:text-white/80 transition-colors">
